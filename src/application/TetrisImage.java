...
final class TetrisImage{
	...
	// アニメ表示カウンタ
	/*
	static int flameAnimeCount = 0;
	static int heroAnimeCount = 0;
	*/
	...
	//static Image magicImg = new Image(new File("magic1.png").toURI().toString());
	...
	// 魔法陣
	static WritableImage magicCircle = new WritableImage(magicImg.getPixelReader(),256, 0, (int) (magicImg.getWidth() / 16), (int) (magicImg.getHeight() / 11));
	...
	// キャラクタアニメ
	// てすと
	public WritableImage heroAnime() {
		WritableImage[] resizedImage = new WritableImage[4];
		resizedImage[0] = new WritableImage(heroImg.getPixelReader(),0, 0, (int) (heroImg.getWidth() / 9), (int) (heroImg.getHeight() / 6));
		resizedImage[1] = new WritableImage(heroImg.getPixelReader(),96, 0, (int) (heroImg.getWidth() / 9), (int) (heroImg.getHeight() / 6));
		resizedImage[2] = new WritableImage(heroImg.getPixelReader(),192, 0, (int) (heroImg.getWidth() / 9), (int) (heroImg.getHeight() / 6));
	...
	// ポーズ中
	public static WritableImage[] heroAnime_1() {
		WritableImage[] resizedImage = new WritableImage[4];
		resizedImage[0] = new WritableImage(heroImg.getPixelReader(),0, 0, (int) (heroImg.getWidth() / 9), (int) (heroImg.getHeight() / 6));
		resizedImage[1] = new WritableImage(heroImg.getPixelReader(),96, 0, (int) (heroImg.getWidth() / 9), (int) (heroImg.getHeight() / 6));
		resizedImage[2] = new WritableImage(heroImg.getPixelReader(),192, 0, (int) (heroImg.getWidth() / 9), (int) (heroImg.getHeight() / 6));
		resizedImage[3] = new WritableImage(heroImg.getPixelReader(),96, 0, (int) (heroImg.getWidth() / 9), (int) (heroImg.getHeight() / 6));
/*
		resizedImage[3] = new WritableImage(heroImg.getPixelReader(),288, 0, (int) (heroImg.getWidth() / 9), (int) (heroImg.getHeight() / 6));
		resizedImage[4] = new WritableImage(heroImg.getPixelReader(),384, 0, (int) (heroImg.getWidth() / 9), (int) (heroImg.getHeight() / 6));
		resizedImage[5] = new WritableImage(heroImg.getPixelReader(),480, 0, (int) (heroImg.getWidth() / 9), (int) (heroImg.getHeight() / 6));
		resizedImage[6] = new WritableImage(heroImg.getPixelReader(),576, 0, (int) (heroImg.getWidth() / 9), (int) (heroImg.getHeight() / 6));
		resizedImage[7] = new WritableImage(heroImg.getPixelReader(),672, 0, (int) (heroImg.getWidth() / 9), (int) (heroImg.getHeight() / 6));
		resizedImage[8] = new WritableImage(heroImg.getPixelReader(),768, 0, (int) (heroImg.getWidth() / 9), (int) (heroImg.getHeight() / 6));
*/
		return resizedImage;
	}

	// 通常モーション（飛行）
	public static WritableImage[] heroAnime_7() {
	...
	// 魔法準備中モーション
	public static WritableImage[] heroAnime_8() {
		WritableImage[] resizedImage = new WritableImage[3];
	...
	public static WritableImage[] heroAnime_9() {
