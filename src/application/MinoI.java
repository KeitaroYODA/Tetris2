...
class MinoI extends Mino {
	...
	protected void initCorrectionLeft() {
		...
		correctionLeftArray[DIRECTION_NORMAL][2][CORRECTION_X] = -1;
		correctionLeftArray[DIRECTION_NORMAL][2][CORRECTION_Y] = -2;
		correctionLeftArray[DIRECTION_NORMAL][3][CORRECTION_X] = 2;
		correctionLeftArray[DIRECTION_NORMAL][3][CORRECTION_Y] = 1;
		// 左向きから左回転時
		correctionLeftArray[DIRECTION_LEFT][0][CORRECTION_X] = -2;
		...
		correctionLeftArray[DIRECTION_LEFT][2][CORRECTION_X] = 1;
		correctionLeftArray[DIRECTION_LEFT][2][CORRECTION_Y] = -2;
		correctionLeftArray[DIRECTION_LEFT][3][CORRECTION_X] = -2;
		correctionLeftArray[DIRECTION_LEFT][3][CORRECTION_Y] = 1;
		// 逆向きから左回転時
		correctionLeftArray[DIRECTION_REVERCE][0][CORRECTION_X] = -2;
		...
		correctionLeftArray[DIRECTION_REVERCE][2][CORRECTION_X] = -2;
		correctionLeftArray[DIRECTION_REVERCE][2][CORRECTION_Y] = -1;
		correctionLeftArray[DIRECTION_REVERCE][3][CORRECTION_X] = 1;
		correctionLeftArray[DIRECTION_REVERCE][3][CORRECTION_Y] = 1;
		// 右向きから左回転時
		correctionLeftArray[DIRECTION_RIGHT][0][CORRECTION_X] = 2;
		...
		correctionLeftArray[DIRECTION_RIGHT][2][CORRECTION_X] = 2;
		correctionLeftArray[DIRECTION_RIGHT][2][CORRECTION_Y] = -1;
	...
	protected void initCorrectionRight() {
		// 正面から右回転時
		correctionRightArray[DIRECTION_NORMAL][0][CORRECTION_X] = -2;
		...
		correctionRightArray[DIRECTION_NORMAL][2][CORRECTION_X] = 1;
		correctionRightArray[DIRECTION_NORMAL][2][CORRECTION_Y] = -2;
		correctionRightArray[DIRECTION_NORMAL][3][CORRECTION_X] = -2;
		correctionRightArray[DIRECTION_NORMAL][3][CORRECTION_Y] = 1;
		// 右向きから右回転時
		correctionRightArray[DIRECTION_RIGHT][0][CORRECTION_X] = 2;
		...
		correctionRightArray[DIRECTION_RIGHT][2][CORRECTION_X] = -1;
		correctionRightArray[DIRECTION_RIGHT][2][CORRECTION_Y] = -2;
		correctionRightArray[DIRECTION_RIGHT][3][CORRECTION_X] = 2;
		correctionRightArray[DIRECTION_RIGHT][3][CORRECTION_Y] = 1;
		// 逆向きから右回転時
		correctionRightArray[DIRECTION_REVERCE][0][CORRECTION_X] = 2;
		...
		correctionRightArray[DIRECTION_REVERCE][2][CORRECTION_X] = 2;
		correctionRightArray[DIRECTION_REVERCE][2][CORRECTION_Y] = -1;
		correctionRightArray[DIRECTION_REVERCE][3][CORRECTION_X] = -1;
		correctionRightArray[DIRECTION_REVERCE][3][CORRECTION_Y] = 1;
		// 左向きから右回転時
		correctionRightArray[DIRECTION_LEFT][0][CORRECTION_X] = -2;
		...
		correctionRightArray[DIRECTION_LEFT][2][CORRECTION_X] = -2;
		correctionRightArray[DIRECTION_LEFT][2][CORRECTION_Y] = -1;
